---
title: GenGrowth Discord 社区简版搭建指南
status: draft
version: v1.0
date: 2026-08-20
...
> 这份文档只解决三个问题：现在要准备什么、你怎么亲手建立服务器、前几周慢慢做什么。
...
本文根据现有 GenGrowth Ops 资料和用户提供的频道架构参考图整理。Discord 界面名称可能随客户端版本变化；下载时应使用 Discord 官方网站或官方应用商店页面。
