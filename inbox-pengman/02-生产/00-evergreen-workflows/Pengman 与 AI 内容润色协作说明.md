...
> 本文是 Pengman 与 AI 进行双模型内容实验、候选选择、反馈、改稿、差异学习和规则升级的唯一详细协作规范。生产记录使用 [[inbox-pengman/04-production/00-evergreen-workflows/统一内容 Brief 模板]] 的字段；调研、候选、人工反馈与学习证据按实际需要写在同一主记录，不另套一份固定长模板。
