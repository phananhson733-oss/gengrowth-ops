...
sources:
  ...
  - inbox-pengman/_archived/已退役入口/instagram-image-content-workflow-已退役-2026-08-07.md
...
自 2026-08-04 起，当前只启用 `@astrologywiki` 与 `@miraaastrology`；热点号暂停，普通爱好者号退役。当前账号分工和未来启用条件以 [[inbox-pengman/02-生产/01-reference/AstrologyWiki 社媒账号分工与内容发布指南]] 为准。
...
- `inbox-pengman/04-production/03-data-review/`
- `inbox-pengman/04-production/03-data-review/历史发布记录/public-account-crawl-log.md`
