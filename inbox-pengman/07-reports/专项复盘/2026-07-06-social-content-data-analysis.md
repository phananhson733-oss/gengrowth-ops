...
> 口径：以 [[inbox-pengman/07-reports/历史发布记录/2026-W28 本周已发布内容合集.md]] 和 [[inbox-pengman/07-reports/历史发布记录/public-account-crawl-log.md]] 为主，公开来源仅补内容链接和账号级数字；后台 analytics 仍统一记 `待补数据`。  
...
- 本次实际重抓到的公开增量：
  ...
  - TikTok 另有 W29 新确认 `Fire Moon signs, did we get you?`，当前 `153 plays / 8 likes / 0 comments / 0 shares`，已另开 [[inbox-pengman/07-reports/2026-W29-weekly-report.md]]
...
### 3.1 Celebrity birth chart explainer

- 平台：YouTube Shorts
- 链接：`https://www.youtube.com/shorts/EFK0KPtyS4M`
- 价值：最接近 Birth Chart Calculator / Rising Sign tool 承接。
- 现在缺口：Studio 里的 shown in feed、viewed vs swiped away、平均观看时长、点击数据。

### 3.2 Rhaenyra character astrology
