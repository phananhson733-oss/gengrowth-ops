...
这里放已经进入制作、发布、复盘，或已从日更主线降级为 evergreen 资产的单条旧选题。

这个目录不是每日选题入口。新的每日选题、内容包、制作方案优先写到 [[inbox-pengman/04-production/06-daily-content-recommendations/README.md|每日内容包]]。
...
- 查旧脚本、旧选题、历史表达时看这里。
- 不在这里新建每日选题池。
- 如果旧选题重新进入生产，应在 [[inbox-pengman/04-production/06-daily-content-recommendations/README.md|每日内容包]] 新建当日内容包，并从这里反链到旧资料。
