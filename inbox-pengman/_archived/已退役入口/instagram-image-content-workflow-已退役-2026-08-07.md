...
archive_reason: 当前暂不生产 Instagram 图文或 Carousel，不再作为现行制作入口
related:
  ...
  - [[inbox-pengman/04-production/03-data-review/README.md]]
  - [[inbox-pengman/02-调研资料/候选与热点研究/README.md]]
  - [[inbox-pengman/04-production/02-content-production/README.md]]
...
> **历史声明（2026-08-07）**：当前暂不启用 Instagram 图文 / Carousel 专项生产，本流程退出现行入口，仅保留历史参考。未来重新启用相关形式时，应根据当时账号、平台和生产方式重新核验，不直接照搬本文件。
...
3. `inbox-pengman/04-production/03-data-review/`
...
5. The selected topic's main production record:
   - `inbox-pengman/04-production/02-content-production/`
...
- inbox-pengman/04-production/03-data-review/ 最近已发布内容
- inbox-pengman/02-调研资料/竞品研究/reference-accounts.md
- inbox-pengman/04-production/02-content-production/ 当前已选主题的主生产记录
