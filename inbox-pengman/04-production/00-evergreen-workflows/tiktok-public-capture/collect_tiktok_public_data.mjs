...
accountSheet.getRange("H2:H" + accountValues.length).format.wrapText = true;
...
postSheet.getRange("B2:B" + postValues.length).format.numberFormat = "@";
...
accountSheet.tables.add("A1:I" + accountValues.length, true, "TikTokAccounts");
postSheet.tables.add("A1:L" + postValues.length, true, "TikTokPosts");
