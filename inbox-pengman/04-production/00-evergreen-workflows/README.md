...
这里保存长期有效的规则和模板。**不要按目录顺序全读**；先从 [[inbox-pengman/04-production/README|内容生产工作区入口]] 判断任务，再打开下表对应的一份文档。
...
| 制作 AI Host / 短视频 | [[inbox-pengman/04-production/00-evergreen-workflows/ai-short-video-production-workflow|AI Short Video Production Workflow]] | 脚本确认后的生成、剪辑、字幕、排期和发布 |
| 制作图文 / Carousel | [[inbox-pengman/04-production/00-evergreen-workflows/instagram-image-content-workflow|Instagram Image Content Workflow]] | 图文数量、Canva、视觉和 caption |
| 起号和养号 | [[inbox-pengman/04-production/00-evergreen-workflows/social-account-warmup-and-launch-workflow|Social Account Warmup and Launch Workflow]] | 账号启动，不是单条内容必读 |
| 查看总控角色与权威顺序 | [[inbox-pengman/04-production/00-evergreen-workflows/ai-advisor/社媒运营总控军师工作手册|社媒运营总控军师工作手册]] | AI 决策边界和证据口径 |
| 查看当前滚动状态 | [[inbox-pengman/04-production/00-evergreen-workflows/ai-advisor/当前状态与决策记录|当前状态与决策记录]] | 当前快照；状态变化后覆盖更新，不作历史档案 |

## 模板

- [[inbox-pengman/04-production/00-evergreen-workflows/templates/weekly-content-plan-template|周计划模板]]
- [[inbox-pengman/04-production/00-evergreen-workflows/统一内容 Brief 模板|统一内容 Brief 模板]]
- [[inbox-pengman/04-production/00-evergreen-workflows/内容生产与学习记录模板|内容生产与学习记录模板]]
