...
1. 先从当前 `03-weekly-content-plans/YYYY-Www 周度内容计划.md` 找到 `content_id`。
...
补充：`hold / cancelled`。完整完成定义见 [[inbox-pengman/04-production/00-evergreen-workflows/weekly-rolling-content-production-sop#8-生命周期、完成定义和 WIP]]。
...
- [[inbox-pengman/04-production/00-evergreen-workflows/内容生产与学习记录模板]]
